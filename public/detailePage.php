    ...
    <section class="flex justify-center items-center bg-gray-100 p-4">
        <div class="w-full max-w-4xl bg-white shadow-lg rounded-lg p-6 space-y-6">
            ...
            <div>
                ...
                <div class="relative">
                <input type="text" id="name" value="<?= $currentUser["username"]; ?>" 
            ...
            <div class="flex justify-end">
                <button type="submit" class="px-6 py-3 text-white bg-orange-500 rounded-lg hover:bg-orange-600 transition duration-300">
                Save Changes
                </button>
            </div>
            </form>
